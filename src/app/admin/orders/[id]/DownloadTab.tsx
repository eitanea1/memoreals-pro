    ...
    return (
      <div className="flex flex-col items-center gap-4 py-12 text-center">
        ...
        <div className="w-48 h-2 bg-[#e2e8f0] rounded-full overflow-hidden">
          <div
            className="h-full bg-[var(--c-brand-mid)] rounded-full transition-all"
            style={{ width: `${(selectedCount / totalChars) * 100}%` }}
          />
        </div>
        <p className="text-sm font-semibold text-[var(--c-brand)]">
    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="rounded-2xl border border-[var(--c-border)] bg-white p-6 flex flex-col gap-3">
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="font-semibold text-[var(--c-dark)]">PDF להדפסה</p>
      ...
      <div className="rounded-2xl border border-[var(--c-border)] bg-white p-6 flex flex-col gap-3">
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="font-semibold text-[var(--c-dark)]">PowerPoint להדפסה</p>
            <p className="text-xs text-[var(--c-muted)] mt-0.5">
      ...
      <div className="rounded-2xl border border-[var(--c-border)] bg-white p-6 flex flex-col gap-3">
        <div className="flex items-start gap-3">
          <span className="text-2xl">📦</span>
          <div>
            <p className="font-semibold text-[var(--c-dark)]">ZIP תמונות גולמיות</p>
            <p className="text-xs text-[var(--c-muted)] mt-0.5">
